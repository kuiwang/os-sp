...
public class HttpUtils {
    ...
    /**
     * TODO 链接配置 TODO 文件下载请求封装 TODO GET请求封装
     * 
     */
     ...
     */
    public static String post(String url, Map<String, Object> params, Map<String, Object> headers,
            String hostname, Integer port, String scheme) {
     ...
     * @throws Exception
     */
    public static HttpResponse postRaw(String url, Map<String, Object> params,
     ...
     */
    public static HttpResponse postRaw(String url, Map<String, Object> params,
            Map<String, Object> headers, String hostname, int port) throws Exception {
     ...
     */
    public static HttpResponse postRaw(String url, Map<String, Object> params,
            Map<String, Object> headers, String hostname, Integer port, String scheme)
            throws Exception {
        HttpHost proxy = new HttpHost(hostname, port, scheme);
     ...
     */
    public static HttpResponse postRaw(String url, Map<String, Object> params,
            Map<String, Object> headers, HttpHost proxy) throws Exception {
