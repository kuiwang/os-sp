 ...
 */
package com.scott.dev.modules.sys.web;
...
import com.scott.dev.common.beanvalidator.BeanValidators;
...
import com.scott.dev.common.utils.excel.ExportExcel;
import com.scott.dev.common.utils.excel.ImportExcel;
        ...
        try {
            ...
            for (User user : list) {
                try {
                    ...
                    failureMsg
                            .append("<br/>登录名 " + user.getLoginName() + " 导入失败：" + ex.getMessage());
                }
            }
            if (failureNum > 0) {
