...
import com.scott.dev.modules.sys.service.OfficeService;
...
public class OfficeController extends BaseController {
    ...
    public String form(Office office, Model model) {
        ...
        if (org.apache.commons.lang3.StringUtils.isBlank(office.getId())
            ...
            office.setCode(office.getParent().getCode() + org.apache.commons.lang3.StringUtils
    ...
    public List<Map<String, Object>> treeData(@RequestParam(required = false) String extId,
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if ((org.apache.commons.lang3.StringUtils.isBlank(extId)
                    ...
                    && ((type == null) || ((type != null)
                            && (type.equals("1") ? type.equals(e.getType()) : true)))
