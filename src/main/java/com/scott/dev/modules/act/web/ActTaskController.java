 ...
 */
package com.scott.dev.modules.act.web;
...
import com.scott.dev.modules.act.service.ActTaskService;
import com.scott.dev.modules.act.utils.ActUtils;
...
public class ActTaskController extends BaseController {
    ...
    public String complete(Act act) {
        actTaskService.complete(act.getTaskId(), act.getProcInsId(), act.getComment(),
                act.getVars().getVariableMap());
        return "true";//adminPath + "/act/task";
    }
    ...
    public String histoicFlow(Act act, String startAct, String endAct, Model model) {
        if (StringUtils.isNotBlank(act.getProcInsId())) {
            List<Act> histoicFlowList = actTaskService.histoicFlowList(act.getProcInsId(), startAct,
                    endAct);
     ...
     *                       <ActivityImpl> actImpls = new ArrayList
     *                       <ActivityImpl>(); ProcessDefinition
     ...
     *                       <ActivityImpl> activitiList =
     *                       def.getActivities();// 获得当前任务的所有节点 List
     *                       <String> activeActivityIds = runtimeService
