...
import com.scott.dev.common.annotation.FieldName;
...
public class ActUtils {
    ...
    public static String getFormUrl(String formKey, Act act) {
        ...
        formUrl.append("&act.taskName=")
                .append(act.getTaskName() != null ? Encodes.urlEncode(act.getTaskName()) : "");
            ...
            for (Method m : entity.getClass().getMethods()) {
                if ((m.getAnnotation(JsonIgnore.class) == null)
                    ...
                    if (m.getName().equals("getAct")) {
                        ...
                        map.put("taskId", org.apache.commons.lang3.ObjectUtils
                                .toString(m.invoke(act, new Object[] {}), ""));
                    } else {
                        field.add(org.apache.commons.lang3.StringUtils
                                .uncapitalize(m.getName().substring(3)));
                        value.add(org.apache.commons.lang3.ObjectUtils
                                .toString(m.invoke(entity, new Object[] {}), ""));
                    }
                }
            }
        } catch (Exception e) {
