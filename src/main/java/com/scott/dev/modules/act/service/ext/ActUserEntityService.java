 ...
 */
package com.scott.dev.modules.act.service.ext;
...
public class ActUserEntityService extends UserEntityManager {
    ...
    public void deleteUser(String userId) {
        ...
        User user = findUserById(userId);
        if (user != null) {
            getSystemService().deleteUser(new com.scott.dev.modules.sys.entity.User(user.getId()));
        }
    }
    ...
    public List<Group> findGroupsByUser(String userId) {
        ...
        for (Role role : getSystemService()
                .findRole(new Role(new com.scott.dev.modules.sys.entity.User(null, userId)))) {
