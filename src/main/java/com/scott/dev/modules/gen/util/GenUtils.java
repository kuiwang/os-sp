 ...
 */
package com.scott.dev.modules.gen.util;
...
import com.scott.dev.common.mapper.JaxbMapper;
import com.scott.dev.common.utils.DateUtils;
import com.scott.dev.common.utils.FileUtils;
import com.scott.dev.common.utils.FreeMarkers;
import com.scott.dev.common.utils.StringUtils;
import com.scott.dev.modules.gen.entity.GenCategory;
...
public class GenUtils {
    ...
    public static Map<String, Object> getDataModel(GenScheme genScheme) {
        ...
        model.put("lastPackageName", org.apache.commons.lang3.StringUtils
        ...
        model.put("className", org.apache.commons.lang3.StringUtils
                .uncapitalize(genScheme.getGenTable().getClassName()));
        model.put("ClassName", org.apache.commons.lang3.StringUtils
                .capitalize(genScheme.getGenTable().getClassName()));
        ...
        model.put("functionAuthor",
                org.apache.commons.lang3.StringUtils.isNotBlank(genScheme.getFunctionAuthor())
        ...
        model.put("urlPrefix", model.get("moduleName")
                + (org.apache.commons.lang3.StringUtils.isNotBlank(genScheme.getSubModuleName())
                    ...
                    if (list != null) {
                        for (String s : list) {
                            if (org.apache.commons.lang3.StringUtils.startsWith(s,
                                ...
                                templateList
                                        .addAll(getTemplateList(
                                                config, org.apache.commons.lang3.StringUtils
                                                        .replace(s, GenCategory.CATEGORY_REF, ""),
                                                false));
                            } else {
        ...
        try {
            ...
            if (file != null) {
                return file.getAbsolutePath() + File.separator
                        + org.apache.commons.lang3.StringUtils.replaceEach(GenUtils.class.getName(),
    ...
    public static void initColumnField(GenTable genTable) {
        for (GenTableColumn column : genTable.getColumnList()) {
            ...
            if (org.apache.commons.lang3.StringUtils.startsWithIgnoreCase(column.getJdbcType(),
                    "CHAR")
                    || org.apache.commons.lang3.StringUtils
                            .startsWithIgnoreCase(column.getJdbcType(), "VARCHAR")
                    || org.apache.commons.lang3.StringUtils
                            .startsWithIgnoreCase(column.getJdbcType(), "NARCHAR")) {
                column.setJavaType("String");
            } else if (org.apache.commons.lang3.StringUtils
                    .startsWithIgnoreCase(column.getJdbcType(), "DATETIME")
                    || org.apache.commons.lang3.StringUtils
                            .startsWithIgnoreCase(column.getJdbcType(), "DATE")
                    || org.apache.commons.lang3.StringUtils
                            .startsWithIgnoreCase(column.getJdbcType(), "TIMESTAMP")) {
                column.setJavaType("java.util.Date");
                column.setShowType("dateselect");
            } else if (org.apache.commons.lang3.StringUtils
                    .startsWithIgnoreCase(column.getJdbcType(), "BIGINT")
                    || org.apache.commons.lang3.StringUtils
                            .startsWithIgnoreCase(column.getJdbcType(), "NUMBER")) {
                // 如果是浮点型
                String[] ss = org.apache.commons.lang3.StringUtils
                        .split(org.apache.commons.lang3.StringUtils
