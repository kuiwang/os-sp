...
import com.scott.dev.modules.cms.dao.ArticleDao;
...
public class StatsService extends BaseService {
    ...
    public List<Category> article(Map<String, Object> paramMap) {
        ...
        if (endDate == null) {
            endDate = org.apache.commons.lang3.time.DateUtils
                    .addDays(org.apache.commons.lang3.time.DateUtils.addMonths(beginDate, 1), -1);
