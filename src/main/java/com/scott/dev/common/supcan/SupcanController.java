 ...
 */
package com.scott.dev.common.supcan;
...
import com.scott.dev.common.supcan.annotation.treelist.SupTreeList;
...
import com.scott.dev.common.supcan.treelist.TreeList;
import com.scott.dev.common.supcan.treelist.cols.Col;
import com.scott.dev.common.supcan.treelist.cols.Group;
import com.scott.dev.common.utils.CacheUtils;
import com.scott.dev.common.utils.SpringContextHolder;
        ...
        for (Method m : clazz.getMethods()) {
            ...
            if (supCol != null) {
                ...
                if (org.apache.commons.lang3.StringUtils.isBlank(col.getName())) {
                    col.setName(org.apache.commons.lang3.StringUtils.uncapitalize(
                            org.apache.commons.lang3.StringUtils.substring(m.getName(), 3)));
                }
