...
import com.scott.dev.test.dao.TestDataChildDao;
import com.scott.dev.test.dao.TestDataMainDao;
import com.scott.dev.test.entity.TestDataChild;
...
public class TestDataMainService extends CrudService<TestDataMainDao, TestDataMain> {
    ...
    public TestDataMain get(String id) {
        ...
        testDataMain
                .setTestDataChildList(testDataChildDao.findList(new TestDataChild(testDataMain)));
        return testDataMain;
    }
