 ...
 */
package com.scott.dev.test.web;
...
import com.scott.dev.test.service.TestDataMainService;
...
public class TestDataMainController extends BaseController {
    ...
    public String list(TestDataMain testDataMain, HttpServletRequest request,
        ...
        Page<TestDataMain> page = testDataMainService
                .findPage(new Page<TestDataMain>(request, response), testDataMain);
